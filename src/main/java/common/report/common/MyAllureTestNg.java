...
public class MyAllureTestNg implements
        ISuiteListener,
        ITestListener,
        IInvokedMethodListener,
        IConfigurationListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyAllureTestNg.class);
    ...
    public MyAllureTestNg(final AllureLifecycle lifecycle) {
        this.lifecycle = lifecycle;
    }

    public MyAllureTestNg() {
...
//        }
    ...
    public String getProjectName() {
        ...
        String projectNameFromAllureSetting = properties.getProperty("allure.rrport.project","defaualtProject")
                .toLowerCase();
        String projectName = System.getProperty("projectName");
        projectName = (projectName == null) ? projectNameFromAllureSetting : projectName.toUpperCase();
        return projectName;
    }

    public String getFunctionName() {
        Properties properties = PropertiesUtils.loadAllureProperties();
        String FunctionNameFromAllureSetting = properties.getProperty("allure.rrport.project","defaualtProject")
                .toLowerCase();
        String FunctionName = System.getProperty("projectName");
        FunctionName = (FunctionName == null) ? FunctionNameFromAllureSetting : FunctionName.toUpperCase();
        return FunctionName;
}

    public String getEnv() {
        Properties properties = PropertiesUtils.loadAllureProperties();
        String envFromAllureSetting = properties.getProperty("allure.rrport.project","defaualtProject")
                .toLowerCase();
        String env = System.getProperty("projectName");
        env = (env == null) ? envFromAllureSetting : env.toUpperCase();
        return env;
    }
    ...
    public String getBuildNo() {
        ...
        String tmpBuildNo = getProjectName() + "-" +getFunctionName() + "-" + getEnv() + date;
        return (buildNo == null) ? tmpBuildNo : buildNo;
    }

    public String getDevBuildNo() {
        return (null == System.getProperty("devBuildNo")) ? "" : System.getProperty("devBuildNo");
    }
}
